...
export default function AdminDashboardPage() {
  return (
    <>
      <PageIntro eyebrow="Painel administrativo" title="Visao geral" description="Acompanhe a operacao demonstrativa da editora." actionHref="/admin/produtos/novo" actionLabel="Novo produto" />
      ...
      <section className="admin-panel">
        <div className="admin-panel__heading"><div><h2>Primeiros passos</h2><p>A estrutura esta pronta para receber os dados locais.</p></div></div>
        <div className="admin-actions">
          <Link href="/admin/produtos/novo"><span>01</span><div><strong>Cadastrar produtos</strong><small>Preencha o catalogo inicial</small></div><b>→</b></Link>
